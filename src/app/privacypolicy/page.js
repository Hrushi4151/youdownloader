...
const page = () => {
  return (
    <div class="w-[90vw] md:w-[80vw] mx-auto my-5">
      <div class="">
        <h1 class=" my-4 font-bold text-2xl">Privacy Policy</h1>
        <p className="text-lg">
          Please take a moment to familiarize yourself with our privacy
          practices and contact us if you have any questions.
        </p>
        <div className="my-4">
          <h3 className="text-xl font-semibold">Personal identification information</h3>
          <p className="text-lg">
        ...
        <div className="my-4">
          <h3 className="text-xl font-semibold ">Non-personal identification information</h3>
          <p className="text-lg">
            ...
            utilized and other similar information. We may collect non-personal
        ...
        <div className="my-4">
          <h3 className="text-xl font-semibold">Web browser cookies</h3>
          <p className="text-lg">
            We may collect non-personal identification information about Users
            whenever they interact with our Site. Non-personal identification
            information may include the browser name, the type of computer and
        ...
        <div className="my-4">
          <h3 className="text-xl font-semibold">Your acceptance of these terms</h3>
          <p className="text-lg">
